      ...
      <div className="group">
        ...
        <div className="group-frame2">
          <div className="frame-text">
            ...
            <h4 className="sp-text">
              Finaldefi operates on a decentralized finance (DeFi) platform,
              integrating a marketing program and an automatic algorithm to
              distribute 100% of the funds to each participant’s position. The
              links in Finaldefi CHAIN are transparent, safe, fast, and fair,
              creating long-term stability for all participants
            </h4>
